...
export const FACE_FAMILIES: FaceFamilyDefinition[] = [
  {id:'face.soft-oval',label:'女子柔和鹅蛋脸',genders:['female'],faceLayerByAge:{child:'layer.face.soft-oval.child',adult:'layer.face.soft-oval.adult',elder:'layer.face.soft-oval.elder'}},
  {id:'face.round-soft',label:'女子圆润脸',genders:['female'],faceLayerByAge:{child:'layer.face.round-soft.child',adult:'layer.face.round-soft.adult',elder:'layer.face.round-soft.elder'}},
  {id:'face.long-narrow',label:'女子长窄脸',genders:['female'],faceLayerByAge:{child:'layer.face.long-narrow.child',adult:'layer.face.long-narrow.adult',elder:'layer.face.long-narrow.elder'}},
  {id:'face.broad-cheek',label:'女子宽颊脸',genders:['female'],faceLayerByAge:{child:'layer.face.broad-cheek.child',adult:'layer.face.broad-cheek.adult',elder:'layer.face.broad-cheek.elder'}},
  {id:'face.square-soft',label:'女子柔方脸',genders:['female'],faceLayerByAge:{child:'layer.face.square-soft.child',adult:'layer.face.square-soft.adult',elder:'layer.face.square-soft.elder'}},
  {id:'face.narrow-chin',label:'女子窄下颌脸',genders:['female'],faceLayerByAge:{child:'layer.face.narrow-chin.child',adult:'layer.face.narrow-chin.adult',elder:'layer.face.narrow-chin.elder'}},
  {id:'face.male-oval',label:'男子椭圆脸',genders:['male'],faceLayerByAge:{child:'layer.face.male-oval.child',adult:'layer.face.male-oval.adult',elder:'layer.face.male-oval.elder'}},
  {id:'face.male-round',label:'男子圆脸',genders:['male'],faceLayerByAge:{child:'layer.face.male-round.child',adult:'layer.face.male-round.adult',elder:'layer.face.male-round.elder'}},
  {id:'face.male-square',label:'男子方脸',genders:['male'],faceLayerByAge:{child:'layer.face.male-square.child',adult:'layer.face.male-square.adult',elder:'layer.face.male-square.elder'}},
  {id:'face.male-long',label:'男子长脸',genders:['male'],faceLayerByAge:{child:'layer.face.male-long.child',adult:'layer.face.male-long.adult',elder:'layer.face.male-long.elder'}},
];

export const VECTOR_LAYERS: VectorLayerAsset[] = [
  // Complete FaceFamily assets: outline + features live together.
  ...
  // Six fixed neck bases: one per PortraitFrame.
  ...
  // Full outfit silhouettes. There is no separate stage body layer.
  { id:'layer.outfit.female-child.poor', slot:'outfit', z:18, shapes:[
  ...
  { id:'layer.outfit.female-elder.plain', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M27 150 C29 136 34 117 45 106 L50 102 Q60 106 70 102 L75 105 C87 118 92 136 94 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M49 100 Q60 106 71 100 L69 105 Q60 110 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M52 103 Q60 107 68 103', stroke:'collar', strokeWidth:.72, opacity:.64 },
    { kind:'path', d:'M36 119 Q60 126 84 119', stroke:'accent', strokeWidth:.82, opacity:.46 },
  ...
  { id:'layer.outfit.female-elder.comfortable', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M27 150 C29 136 34 117 45 106 L50 102 Q60 106 70 102 L75 105 C87 118 92 136 94 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M49 100 Q60 106 71 100 L69 105 Q60 110 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M52 103 Q60 107 68 103', stroke:'collar', strokeWidth:.72, opacity:.64 },
    { kind:'path', d:'M35 116 Q60 124 85 116 M39 122 Q60 128 81 122', stroke:'accent', strokeWidth:.9, opacity:.56 },
  ...
  { id:'layer.outfit.female-elder.wealthy', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M27 150 C29 136 34 117 45 106 L50 102 Q60 106 70 102 L75 105 C87 118 92 136 94 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M49 100 Q60 106 71 100 L69 105 Q60 110 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M52 103 Q60 107 68 103', stroke:'collar', strokeWidth:.72, opacity:.64 },
    { kind:'path', d:'M33 114 Q60 124 87 114 M37 121 Q60 129 83 121 M42 128 Q60 133 78 128', stroke:'accent', strokeWidth:1, opacity:.62 },
  ...
  { id:'layer.outfit.male-child.poor', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M34 150 C35 129 39 108 47 93 L53 91 Q60 97 67 91 L73 93 C81 108 85 129 86 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.8 },
    { kind:'path', d:'M52 90 Q60 96 68 90 L66 94 Q60 99 54 94Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M31 119 Q37 116 44 119 M84 124 L91 122', stroke:'accent', strokeWidth:.68, opacity:.42 },
  ]},

  { id:'layer.outfit.male-child.plain', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M34 150 C35 129 39 108 47 93 L53 91 Q60 97 67 91 L73 93 C81 108 85 129 86 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.8 },
    { kind:'path', d:'M52 90 Q60 96 68 90 L66 94 Q60 99 54 94Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M36 119 Q60 126 84 119', stroke:'accent', strokeWidth:.82, opacity:.46 },
  ]},

  { id:'layer.outfit.male-child.comfortable', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M34 150 C35 129 39 108 47 93 L53 91 Q60 97 67 91 L73 93 C81 108 85 129 86 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.8 },
    { kind:'path', d:'M52 90 Q60 96 68 90 L66 94 Q60 99 54 94Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M35 116 Q60 124 85 116 M39 122 Q60 128 81 122', stroke:'accent', strokeWidth:.9, opacity:.56 },
  ]},

  { id:'layer.outfit.male-child.wealthy', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M34 150 C35 129 39 108 47 93 L53 91 Q60 97 67 91 L73 93 C81 108 85 129 86 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.8 },
    { kind:'path', d:'M52 90 Q60 96 68 90 L66 94 Q60 99 54 94Z', fill:'collar', stroke:'ink', strokeWidth:.42 },
    { kind:'path', d:'M33 114 Q60 124 87 114 M37 121 Q60 129 83 121 M42 128 Q60 133 78 128', stroke:'accent', strokeWidth:1, opacity:.62 },
  ]},

  { id:'layer.outfit.male-adult.poor', slot:'outfit', z:18, shapes:[
  ...
  { id:'layer.outfit.male-adult.plain', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M16 150 C18 132 23 113 43 95 L50 92 L60 101 L71 93 L77 95 C97 113 102 132 104 150Z', fill:'cloth', stroke:'ink', strokeWidth:2.2 },
    { kind:'path', d:'M49 91 L60 100.5 L57.2 105 L45.5 95Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M71.5 92 L60 100.5 L63 105 L76.5 96Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M60 100.5 L70.5 107.5', stroke:'ink', strokeWidth:.4, opacity:.36 },
  ...
  { id:'layer.outfit.male-adult.comfortable', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M16 150 C18 132 23 113 43 95 L50 92 L60 101 L71 93 L77 95 C97 113 102 132 104 150Z', fill:'cloth', stroke:'ink', strokeWidth:2.2 },
    { kind:'path', d:'M49 91 L60 100.5 L57.2 105 L45.5 95Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M71.5 92 L60 100.5 L63 105 L76.5 96Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M60 100.5 L70.5 107.5', stroke:'ink', strokeWidth:.4, opacity:.36 },
  ...
  { id:'layer.outfit.male-adult.wealthy', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M16 150 C18 132 23 113 43 95 L50 92 L60 101 L71 93 L77 95 C97 113 102 132 104 150Z', fill:'cloth', stroke:'ink', strokeWidth:2.2 },
    { kind:'path', d:'M49 91 L60 100.5 L57.2 105 L45.5 95Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M71.5 92 L60 100.5 L63 105 L76.5 96Z', fill:'collar', stroke:'ink', strokeWidth:.45 },
    { kind:'path', d:'M60 100.5 L70.5 107.5', stroke:'ink', strokeWidth:.4, opacity:.36 },
  ...
  { id:'layer.outfit.male-elder.poor', slot:'outfit', z:18, shapes:[
  ...
  { id:'layer.outfit.male-elder.plain', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M22 150 C24 133 30 116 43 104 L50 100 Q60 104 70 100 L77 104 C90 116 96 133 98 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M48.5 99 Q60 105 71.5 99 L69 105 Q60 109 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.48 },
    { kind:'path', d:'M52 104 Q60 108 68 104', stroke:'accent', strokeWidth:.64, opacity:.42 },
    { kind:'path', d:'M36 119 Q60 126 84 119', stroke:'accent', strokeWidth:.82, opacity:.46 },
  ...
  { id:'layer.outfit.male-elder.comfortable', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M22 150 C24 133 30 116 43 104 L50 100 Q60 104 70 100 L77 104 C90 116 96 133 98 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M48.5 99 Q60 105 71.5 99 L69 105 Q60 109 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.48 },
    { kind:'path', d:'M52 104 Q60 108 68 104', stroke:'accent', strokeWidth:.64, opacity:.42 },
    { kind:'path', d:'M35 116 Q60 124 85 116 M39 122 Q60 128 81 122', stroke:'accent', strokeWidth:.9, opacity:.56 },
  ...
  { id:'layer.outfit.male-elder.wealthy', slot:'outfit', z:18, shapes:[
    { kind:'path', d:'M22 150 C24 133 30 116 43 104 L50 100 Q60 104 70 100 L77 104 C90 116 96 133 98 150Z', fill:'cloth', stroke:'ink', strokeWidth:1.95 },
    { kind:'path', d:'M48.5 99 Q60 105 71.5 99 L69 105 Q60 109 51 105Z', fill:'collar', stroke:'ink', strokeWidth:.48 },
    { kind:'path', d:'M52 104 Q60 108 68 104', stroke:'accent', strokeWidth:.64, opacity:.42 },
    { kind:'path', d:'M33 114 Q60 124 87 114 M37 121 Q60 129 83 121 M42 128 Q60 133 78 128', stroke:'accent', strokeWidth:1, opacity:.62 },
...
export const OUTFIT_STYLES: OutfitStyleDefinition[] = [
  {id:'outfit.poor.v2',label:'贫寒单层衣',frameIds:['female.child','female.elder','male.child','male.adult','male.elder'],initialWealthTiers:['poor'],layerAssetIdsByFrame:{'female.child':['layer.outfit.female-child.poor'],'female.elder':['layer.outfit.female-elder.poor'],'male.child':['layer.outfit.male-child.poor'],'male.adult':['layer.outfit.male-adult.poor'],'male.elder':['layer.outfit.male-elder.poor']},baseWeight:1},
  {id:'outfit.plain.v2',label:'普通衣',frameIds:['female.child','female.elder','male.child','male.adult','male.elder'],initialWealthTiers:['plain'],layerAssetIdsByFrame:{'female.child':['layer.outfit.female-child.plain'],'female.elder':['layer.outfit.female-elder.plain'],'male.child':['layer.outfit.male-child.plain'],'male.adult':['layer.outfit.male-adult.plain'],'male.elder':['layer.outfit.male-elder.plain']},baseWeight:1},
  {id:'outfit.comfortable.v2',label:'殷实叠领衣',frameIds:['female.child','female.elder','male.child','male.adult','male.elder'],initialWealthTiers:['comfortable'],layerAssetIdsByFrame:{'female.child':['layer.outfit.female-child.comfortable'],'female.elder':['layer.outfit.female-elder.comfortable'],'male.child':['layer.outfit.male-child.comfortable'],'male.adult':['layer.outfit.male-adult.comfortable'],'male.elder':['layer.outfit.male-elder.comfortable']},baseWeight:1},
  {id:'outfit.wealthy.v2',label:'富裕层领衣',frameIds:['female.child','female.elder','male.child','male.adult','male.elder'],initialWealthTiers:['wealthy'],layerAssetIdsByFrame:{'female.child':['layer.outfit.female-child.wealthy'],'female.elder':['layer.outfit.female-elder.wealthy'],'male.child':['layer.outfit.male-child.wealthy'],'male.adult':['layer.outfit.male-adult.wealthy'],'male.elder':['layer.outfit.male-elder.wealthy']},baseWeight:1},
  {id:'outfit.female.adult.work-cross-collar',label:'成年女子粗布交领短衣',frameIds:['female.adult'],initialWealthTiers:['poor','plain'],layerAssetIdsByFrame:{'female.adult':['layer.outfit.female-adult.work-cross-collar']},baseWeight:1},
  {id:'outfit.female.adult.plain-cross-collar',label:'成年女子素色交领衫',frameIds:['female.adult'],initialWealthTiers:['plain','comfortable'],layerAssetIdsByFrame:{'female.adult':['layer.outfit.female-adult.plain-cross-collar']},baseWeight:1.2},
  {id:'outfit.female.adult.layered-cross-collar',label:'成年女子叠领襦衣',frameIds:['female.adult'],initialWealthTiers:['comfortable','wealthy'],layerAssetIdsByFrame:{'female.adult':['layer.outfit.female-adult.layered-cross-collar']},baseWeight:1},
  {id:'outfit.female.adult.front-opening-jacket',label:'成年女子对襟罩衫',frameIds:['female.adult'],initialWealthTiers:['comfortable','wealthy'],layerAssetIdsByFrame:{'female.adult':['layer.outfit.female-adult.front-opening-jacket']},baseWeight:.9},
];
