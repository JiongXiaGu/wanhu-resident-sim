...
const paint:Partial<Record<OutfitId,Paint>>={
 ...
 artisan:{base:'#889394',trim:'#e6d8ba',accent:'#ad8a60',cut:'apron'},
 'adult-female-ruqun':{base:'#b3868e',trim:'#f5e9d5',accent:'#796178',cut:'ruqun'},
...
export function outfitArt(frame:Frame,id:OutfitId):string{
 ...
 const y=child?-1:elder?3:0,end=child?214:elder?221:226;
 ...
 if(colors.cut==='round'){
  ...
  // 先画后襟，再画从左颈根连续跨到右下方的前襟；交点没有悬空的两片三角领。
  collar=p(`M181 ${236+y}Q185 ${244+y} 191 ${250+y}L158 ${281+y}L147 ${270+y}Z`,colors.trim,OUTLINE,3);
  collar+=p(`M138 ${235+y}Q140 ${242+y} 149 ${249+y}L${end} 307L${end-11} 323L132 ${259+y}Q124 ${252+y} 128 ${245+y}Z`,colors.trim,OUTLINE,3);
  detail=l(`M141 ${250+y}L${end-7} 313`,colors.accent,1.7,.52);
  if(colors.cut==='warm'){
  ...
  if(colors.cut==='ruqun'){
   overlay=p('M75 302Q159 310 245 302L251 324H69Z',colors.accent,'none',0)
     +l('M76 303Q160 311 244 303',OUTLINE,2.7);
   detail=l('M160 310L150 322M162 310L179 321',colors.trim,2.7,.8);
