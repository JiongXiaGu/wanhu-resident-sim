...
先读 `Documentation/Phase 8 头像美术体系与创作工坊.md` 与 `Documentation/Phase 8B2 成年衣装与衣领审查.md`。8B1 已交付；本批重画剩余成年 12 Hair / 9 Outfit ID，并一起修儿童小褂、老者罩衣、掌柜长衫三款。没有新增 ID；8A 成年样板保留，累计“已重画”仍只是候选，不是用户最终认可。Phase 8C 仅登记年龄/性别入口与创作对象清晰度任务，不在本批重排 UI。
