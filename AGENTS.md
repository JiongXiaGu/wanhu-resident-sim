...
Portrait-first、Resident Profile V1 与头像基线保持完成状态。Routine Library V2 的 R3C Family Contract 与 R3D 家庭 Eligibility 内容已完成；当前全库 247 / 460，family-constrained=20、context=0。下一步 R3E 增加具体家人 ContextResidentId 条目并收尾 R3；不要同时开启头像扩库、8C、环境/民俗扩库或最终 Unity ECS 实现。
