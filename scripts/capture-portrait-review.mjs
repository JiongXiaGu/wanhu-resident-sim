...
const contract=await page.locator('[data-portrait-v8-lab]').getAttribute('data-render-contract-version');
...
if(await page.locator('[data-face-family-card]').count()!==6) throw new Error('V8.4 must show six FaceFamily assets.');
if(await page.locator('[data-hair-style-card]').count()!==4) throw new Error('V8.4 must show four initial HairStyle assets.');
