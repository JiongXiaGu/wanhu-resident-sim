...
if (files.length === 0) throw new Error(`No PNG review screenshots found in ${outDir}.`);
console.log(`Compressed ${files.length} screenshots: ${(totalBefore / 1024 / 1024).toFixed(1)} MB -> ${(totalAfter / 1024 / 1024).toFixed(1)} MB`);
