...
修正提交 `1916d91e5cc12dc21e2c86de3f4f05d28b22268c` 已通过两项workflow，并下载Artifact `10611768493` 核对源码与截图；额角余量和单部件对照已复查。具体候选run及当前执行点以主路线工作流为准；最终main须有自己的PASS与Artifact。当前完成的是儿童/老年候选，不是整套头像美术定稿。
